...
const double vMu = 0.0001; // Mean of gaussian for cell speeds. (microns/min).
const double vSigma = 0.00001; // Sigma of cell speed distribution. (microns/min). 
...
const double K4 = 0.5; // Gel stiffness
const double K5 = 0.05; // Water spring stiffness.
const double K6 = 0.1; // Spring for repulsion between water layer and cells.
const double sT = 0.001; // Water downward pull towards gel.
...
const double waterRadius = 0.2; // Size of water beads.
const double waterRadiusFactor = 10.0; // Water bead radius that cells feel.
...
const int maxN = 1; // Maximum number of cells.
const double maxT = 20.0; // Maximum time (minutes).
